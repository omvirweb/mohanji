    ...
    function get_account_old_balance($account_id){
        ...
        if(!empty($account_id)){
            ...
            if(!empty($account_data)){
                ...
                $data['gold_fine'] = round($get_total_gold_fine_purchase->result()[0]->fine-$get_total_gold_fine_sale->result()[0]->fine+$get_metal_total_gold_fine_purchase->result()[0]->fine-$get_metal_total_gold_fine_sale->result()[0]->fine+$get_total_gold_bhav_purchase->result()[0]->fine-$get_total_gold_bhav_sale->result()[0]->fine+$get_total_mhmifw_purchase->result()[0]->fine+$get_total_mhmifw_purchase2->result()[0]->fine-$get_total_mhmifw_sale->result()[0]->fine+$get_total_irkw->result()[0]->fine+$get_total_mfi_purchase->result()[0]->fine-$get_total_mfi_sale->result()[0]->fine,3);
