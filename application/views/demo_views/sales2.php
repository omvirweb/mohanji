                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="line_item_form item_fields_div" style="height: 160px;">
                                        ...
                                        <div class="col-md-1 pr0">
                                            <label for="labout_other_charges">Charges <small>Labout + Other</small><span class="required-sign">&nbsp;*</span></label>
                                        ...
                                        <table style="" class="table custom-table border item-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="5%" class="text-right">Labout + Other Charges</th> 
                                            ...
                                            <tfoot id="lineitem_foot_list">
                                                <tr>
                                                    ...
                                                    <th class="text-right"></th>
                                                    <th class="text-right">342782.64</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                        ...
                                        <table style="" class="table custom-table item-table">
                                            <tbody id="pop_up_total_list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="6%" class="text-right">342780.64</th>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
