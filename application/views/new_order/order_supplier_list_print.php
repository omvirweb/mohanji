...
<html>
    ...
    <body>
        ...
        <table>
            <tr>
                <td>Order No : <b><?php echo $new_order_data->order_no; ?></b></td>
            ...
            <tr>
                ...
                <?php /*<td>Delivery Date : <b><?php echo (isset($new_order_data->delivery_date))? date('d-m-Y', strtotime($new_order_data->delivery_date)) : ''; ?></b></td>*/ ?>
                <td>Supplier : <b><?php echo isset($supplier_name)?$supplier_name:''; ?></b></td>
            </tr>
            <tr>
                <td>Remark : <b style="font-size: 25px; "><?php echo $order_lot_item_data->lot_remark; ?></b></td>
                <td>Supplier Delivery Date : <b><?php echo (isset($new_order_data->supplier_delivery_date))? date('d-m-Y', strtotime($new_order_data->supplier_delivery_date)) : ''; ?></b></td>
            </tr>
        </table>
