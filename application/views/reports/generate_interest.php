<div class="content-wrapper">   
    <section class="content-header">
        <h1> 
            <a href="<?= base_url('reports/interest') ?>" class="btn btn-primary btn-sm" style="margin: 5px;" ><i class="fa fa-arrow-left"></i> Back</a>
            Generate Interest
        </h1>
    </section>
    <div class="clearfix">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (json['success'] == 'Added') {
                            window.location.href = "<?php echo base_url('reports/interest') ?>";
                        } else {
