...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            ?>
            <?php if($isAdd){ ?>
                <a href="<?=base_url('inventory/import_data') ?>" class="btn btn-primary btn-sm pull-right" style="margin: 5px;">Import Data</a>
            <?php } ?>
        </h1>
    </section>
    <div class="clearfix">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
            <div class="modal-header">
                ...
                <h4 class="modal-title">Data Detail Table</h4>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#issue_receive_table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('inventory/data_datatable') ?>",
                "type": "POST",
                "data": function (d) {
        ...
        item_table = $('#item_table').DataTable({
            ...
            "paging": false,
            "ajax": {
                "url": "<?php echo site_url('inventory/data_detail_datatable') ?>",
                "type": "POST",
                "data": function (d) {
