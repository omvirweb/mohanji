...
<div class="content-wrapper" id="body-content">
    <form class="form-horizontal" action="<?= base_url('tunch_testing/save_entry') ?>" method="post" id="save_sell_purchase" novalidate enctype="multipart/form-data">
        <div class="clearfix">
            <div class="row">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 padding_sm" style="background-color: #92E2BD;">
                                        <label for="purchase_gr_wt">Purchase Gr wt(F1)</label>
                                        <input type="text" name="purchase_gr_wt" id="purchase_gr_wt" class="form-control num_only input_class" tabindex="4" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #92E2BD;">
                                        <label for="purchase_tunch">Tunch</label>
                                        <input type="text" name="purchase_tunch" id="purchase_tunch" class="form-control num_only input_class" tabindex="5" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #92E2BD;">
                                        <label for="purchase_fine">Fine</label>
                                        <input type="text" name="purchase_fine" id="purchase_fine" class="form-control num_only input_class" tabindex="6" value=""><br />
                                    </div>
                                    <div class="col-md-2 padding_sm" style="background-color: #F8CB81;">
                                        <label for="payment_amount">Payment Amount(F2)</label>
                                        <input type="text" name="payment_amount" id="payment_amount" class="form-control num_only input_class" tabindex="7" value=""><br />
                                    </div>
                                    <div class="col-md-2 padding_sm" style="background-color: #A3C9FF;">
                                        <label for="receipt_amount">Receipt Amount(F3)</label>
                                        <input type="text" name="receipt_amount" id="receipt_amount" class="form-control num_only input_class" tabindex="8" value=""><br />
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-md-2 padding_sm" style="background-color: #D3C2FF; padding-bottom: 20px;">
                                        <label for="gold_bhav_type_id">Gold / Silver Bhav(F4)</label>
                                        <select name="gold_bhav_type_id" id="gold_bhav_type_id" class="form-control select2" tabindex="9">
                                            <option value="1">Sell</option>
                                            <option value="2">Purchase</option>
                                        </select><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #D3C2FF;">
                                        <label for="gold_bhav_gr_wt">Gr wt</label>
                                        <input type="text" name="gold_bhav_gr_wt" id="gold_bhav_gr_wt" class="form-control num_only input_class" tabindex="10" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #D3C2FF;">
                                        <label for="gold_bhav_rate">Rate</label>
                                        <input type="text" name="gold_bhav_rate" id="gold_bhav_rate" class="form-control num_only input_class" tabindex="11" value=""><br />
                                    </div>
                                    <div class="col-md-2 padding_sm" style="background-color: #D3C2FF;">
                                        <label for="gold_bhav_amount">Amount</label>
                                        <input type="text" name="gold_bhav_amount" id="gold_bhav_amount" class="form-control num_only input_class" readonly="" tabindex="12" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #FFC2B3; padding-bottom: 28px;">
                                        <br/>
                                        <label for="auto_fill_pending_wt">Auto</label>
                                        <input type="checkbox" name="auto_fill_pending_wt" id="auto_fill_pending_wt" class="" style="height:17px; width: 17px;" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #FFC2B3;">
                                        <label for="sell_gr_wt">Sell Gr wt(F5)</label>
                                        <input type="text" name="sell_gr_wt" id="sell_gr_wt" class="form-control num_only input_class" tabindex="13" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #FFC2B3;">
                                        <label for="sell_tunch">Tunch</label>
                                        <input type="text" name="sell_tunch" id="sell_tunch" class="form-control num_only input_class" tabindex="14" value="100.000"><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #FFC2B3;">
                                        <label for="sell_fine">Fine</label>
                                        <input type="text" name="sell_fine" id="sell_fine" class="form-control num_only input_class" tabindex="15" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #ffffff;">
                                        <label for="remark">Remark</label>
                                        <input type="text" name="remark" id="remark" class="form-control input_class" tabindex="16" value=""><br />
                                    </div>
                                    <div class="col-md-1 padding_sm" style="background-color: #ffffff;">
                                        <br/>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('submit', '#save_sell_purchase', function () {
            ...
            $.ajax({
                url: "<?= base_url('tunch_testing/save_entry') ?>",
                type: "POST",
                processData: false,
                contentType: false,
                cache: false,
