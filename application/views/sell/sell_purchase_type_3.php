                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="line_item_form item_fields_div" style="height: 160px;">
                                        <?php if(isset($sell_purchase) && $sell_purchase != 'payment_receipt' && $sell_purchase != 'metal_issue_receive'){ ?>
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-1 pr0 <?php echo (isset($sell_purchase) && $sell_purchase != 'sell_purchase') ? 'hidden' : ''; ?>">
                                        ...
                                        <?php if($use_category == '1') { ?>
                                            <div class="pull-left" style="width:170px; margin-left: 5px;">
                                        ...
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            <label for="stamp_id">Stamp<span class="required-sign"></span></label>
                                            <select name="line_items_data[stamp_id]" class="form-control stamp_id select2" id="stamp_id"></select>
                                        </div>
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            <label for="grwt">Gr.Wt.<span class="required-sign">&nbsp;*</span></label>
                                            <input type="text" name="line_items_data[grwt]" class="form-control p5 grwt num_only" id="grwt" placeholder="" value="">
                                        </div>
                                        <?php if($less_netwt_2 == '1') { ?>
                                            <div class="pull-left" style="width:75px; margin-left: 5px;">
                                                ...
                                                <input type="text" name="line_items_data[less]" class="form-control p5 less num_only" id="less"  placeholder="" value="">
                                            </div>
                                            <div class="pull-left" style="width:70px; margin-left: 5px;">
                                                <label for="net_wt">Net.Wt<span class="required-sign">&nbsp;*</span></label>
                                                <input type="text" name="line_items_data[net_wt]" class="form-control p5 net_wt num_only" id="net_wt" placeholder="" value="" readonly="">
                                            </div>
                                        <?php } else { ?>
                                        ...
                                        <?php } ?>
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            <label for="spi_loss_for" style="font-size: 11px;">Loss @1000<span class="required-sign">&nbsp;*</span></label>
                                            <input type="text" name="line_items_data[spi_loss_for]" class="form-control p5 num_only" id="spi_loss_for" placeholder="" value="">
                                        </div>
                                        <div class="pull-left" style="width:70px; margin-left: 5px;">
                                            <label for="spi_loss">Loss<span class="required-sign">&nbsp;*</span></label>
                                            <input type="text" name="line_items_data[spi_loss]" class="form-control p5 num_only" id="spi_loss" placeholder="" value="" readonly="">
                                        </div>
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            ...
                                            <div class="touch_input">
                                                <input type="text" name="line_items_data[touch_id]" id="touch_data_id" class="form-control p5 touch_id num_only" value="">
                                            </div>
                                        </div>
                                        <?php if($wstg_2 == '1') { ?>
                                            <div class="pull-left" style="width:75px; margin-left: 5px;">
                                                <label for="wstg">Wstg<span class="required-sign field_required">&nbsp;*</span></label>
                                                <input type="text" name="line_items_data[wstg]" class="form-control p5 wstg num_only" id="wstg" placeholder="" value="" >
                                        ...
                                        <div class="pull-left" style="width:70px; margin-left: 5px;">
                                            ...
                                            <input type="text" name="line_items_data[fine]" class="form-control p5 fine" id="fine" placeholder="" value="" readonly>
                                        </div>
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            <label for="spi_pcs">Pcs</label>
                                            <input type="text" name="line_items_data[spi_pcs]" class="form-control p5 num_only" id="spi_pcs" placeholder="" value="">
                                        </div>
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            <label for="spi_rate" style="font-size: 11px;">Rate</label>
                                            <input type="text" name="line_items_data[spi_rate]" class="form-control p5 num_only" id="spi_rate" placeholder="" value="">
                                            <input type="hidden" name="line_items_data[spi_rate_of]" class="form-control p5 num_only" id="spi_rate_of">
                                        </div>
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            <label for="spi_labour_on">On</label>
                                            <select name="line_items_data[spi_labour_on]" class="form-control select2" id="spi_labour_on">
                                                <option value="2">NetWt@1000</option>
                                                <option value="1">PCS</option>
                                            </select>
                                        </div>
                                        <div class="pull-left" style="width:75px; margin-left: 5px;">
                                            <label for="labour_amount">Amt</label>
                                            <input type="text" name="line_items_data[labour_amount]" class="form-control p5" id="labour_amount" placeholder="" value="" readonly>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <table style="" class="table custom-table border item-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th width="7%" class="text-right">Fine</th>
...
<?php } ?>
    ...
    $(document).ready(function () {
        ...
        <?php } ?>
        <?php if(isset($sell_purchase) && $sell_purchase == 'payment_receipt'){ ?>
...
//                console.log(value);
        ...
        <?php } ?>
        initAjaxSelect2($("#metal_item_id"), "<?= base_url('app/item_default_and_combine_for_metal_select2_source') ?>");
        ...
        initAjaxSelect2($("#stamp_id"), "<?= base_url('app/stamp_select2_source') ?>");
...
//            console.log(pts_grwt + ' ' + pe_stock_grwt);
        ...
        $(document).on('keyup change', '#grwt, #less', function () {
            ...
            net_wt = round(net_wt, 0).toFixed(0);
            $('#net_wt').val(net_wt).change();
        });

        $(document).bind('keyup change', '#net_wt, #spi_loss_for, .touch_id, #wstg', function () {
            var net_wt = parseFloat($('#net_wt').val()) || 0;
            net_wt = round(net_wt, 2).toFixed(3);
            var spi_loss_for = parseFloat($('#spi_loss_for').val()) || 0;
            ...
            var spi_loss = 0;
            spi_loss = parseFloat(net_wt) * parseFloat(spi_loss_for) / 1000;
            spi_loss = round(spi_loss, 0).toFixed(0);
            $('#spi_loss').val(spi_loss);

            var fine = 0;
            fine = (parseFloat(net_wt) + parseFloat(spi_loss)) * (parseFloat(touch) + parseFloat(wstg)) / 100;
            fine = round(fine, 0).toFixed(0);
            $('#fine').val(fine);
        });

        $(document).bind('keyup change', '#spi_pcs, #spi_rate, #spi_labour_on', function () {
            var spi_pcs = parseFloat($('#spi_pcs').val()) || 0;
            var spi_rate = parseFloat($('#spi_rate').val()) || 0;
            var spi_labour_on = parseFloat($('#spi_labour_on').val()) || 0;
            var net_wt = parseFloat($('#net_wt').val()) || 0;
            net_wt = round(net_wt, 2).toFixed(3);
            var labour_amount = 0;
            if(spi_labour_on == '1'){
                labour_amount = parseFloat(spi_pcs) * parseFloat(spi_rate);
            } else if(spi_labour_on == '2'){
                labour_amount = parseFloat(net_wt) * parseFloat(spi_rate) / 1000;
            }
            labour_amount = round(labour_amount, 2).toFixed(2);
...
//            console.log(clickbtn['selector']); return false;
            ...
            var href_url = '<?= base_url('sell_purchase_type_3/save_sell') ?>';
            if(is_grater == 1){
        ...
        $('#add_lineitem').on('click', function () {
            ...
            lineitem['labour_amount'] = parseFloat($('#labour_amount').val()) || 0;
            lineitem['charges_amt'] = parseFloat($('#labour_amount').val()) || 0;
...
//            });
                        ...
                        if (sell_type_id == '1') {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    $("#item_id").val(null).trigger("change");
                                    $("#li_narration").val('');
                                    $("#stamp_id").val(null).trigger("change");
                                    $("#grwt").val('');
                                    $("#less").val('');
                                    $('#less').removeAttr('readonly', 'readonly');
                                    $('#less_ad_details').removeClass('hide');
                                    ...
                                    $("#spi_pcs").val('');
                                    $("#spi_rate").val('');
                                    $("#spi_labour_on").val(null).trigger("change");
                                    $("#labour_amount").val('');
                                    $("#charges_amt").val('');
                                    $("#image").val('');
                                    $("#file_upload").val('');
    ...
    function display_lineitem_html(lineitem_objectdata) {
        ...
        $.each(lineitem_objectdata, function (index, value) {
            ...
            var spi_rate_of = value.spi_rate_of || 1;
            if(spi_rate_of == '2' && spi_rate != 0){
                fine = 0;
//                lineitem_objectdata[index].fine = 0;
            }
...
//        console.log(value);
        ...
        $("#stamp_id").val(value.stamp_id).trigger("change");
        setSelect2Value($("#stamp_id"), "<?= base_url('app/set_stamp_select2_val_by_id/') ?>" + value.stamp_id);
        if(value.purchase_sell_item_id == '' || value.purchase_sell_item_id == null){
            ...
            $("#spi_loss_for").val(value.spi_loss_for);
            $("#spi_loss").val(value.spi_loss);
            $(".touch_id").val(value.touch_id).trigger("change");
            $(".wstg").val(value.wstg);
            $("#fine").val(value.fine);
            $("#spi_pcs").val(value.spi_pcs);
            $("#spi_rate").val(value.spi_rate);
            $("#spi_rate_of").val(value.spi_rate_of);
            $("#spi_labour_on").val(value.spi_labour_on).trigger("change");
...
//            console.log(input.files);
    ...
    function save_form(postData, href_url){
        ...
        postData.append('sell_purchase', sell_purchase);
        $.ajax({
            url: href_url,
            type: "POST",
            processData: false,
