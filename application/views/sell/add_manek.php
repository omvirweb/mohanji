                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="line_item_form item_fields_div" style="height: 160px;">
                                        ...
                                        <?php } ?>
                                        <input type="hidden" name="line_items_data[touch_id]" id="touch_data_id" class="form-control touch_id num_only" value="100">
                                        <input type="hidden" name="line_items_data[wstg]" id="wstg" value="0" class="wstg">
                                        <input type="hidden" name="line_items_data[default_wstg]" id="default_wstg" value="0">
                                        <input type="hidden" name="line_items_data[fine]" class="form-control fine" id="fine" value="">
                                        <div class="col-md-1 pr0">
                                            <label for="spi_pcs">Pcs</label>
                                            <input type="text" name="line_items_data[spi_pcs]" class="form-control num_only" id="spi_pcs">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="spi_rate">Rate</label>
                                            <input type="text" name="line_items_data[spi_rate]" class="form-control num_only" id="spi_rate">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="spi_amount">Amount</label>
                                            <input type="text" name="line_items_data[amount]" class="form-control num_only" id="spi_amount" readonly="">
                                        </div>
                                        ...
                                        <table style="" class="table custom-table border item-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th width="5%" class="text-right">Pcs</th>
                                                    <th width="4%" class="text-right">Rate</th>
                                                    <th width="4%" class="text-right">Charges</th>
                                            ...
                                            <tfoot id="lineitem_foot_list">
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th class="text-right"><span id="total_pcs"></span></th>
                                                    <th class="text-right"></th>
                                                    <th class="text-right"><span id="total_charges"></span></th>
                                        ...
                                        <table style="" class="table custom-table item-table">
                                            <tbody id="pop_up_total_list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th>Bal.Date : </th>
                                                    <th colspan="2"><span id="balance_date"></span></th>
                                                ...
                                                <?php if($ask_discount_in_sell_purchase == '1') { ?>
                                                    <tr>
                                                        ...
                                                        <th></th>
                                                        <th></th>
                                                        <th class="text-right"><input type="text" name="discount_amount" class="form-control num_only" id="discount_amount" value="<?php if (isset($sell_data->discount_amount) && !empty($sell_data->discount_amount)) { echo $sell_data->discount_amount; } else { echo '';} ?>" ></th>
                                                        <?php if($lineitem_image_2 == '1') { ?>
                                                            <th></th>
                                                        <?php } ?>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th></th>
                                                        <th></th>
                                                        <th colspan="2" class="text-right">New Net Balance : </th>
                                                        <th class="text-right"><span id="new_net_gold_fine" class="label label-success" style="font-size: 14px;"></span></th>
                                                        <th class="text-right"><span id="new_net_silver_fine" class="label label-success" style="font-size: 14px;"></span></th>
                                                        <th class="text-right"><span id="new_net_amount" class="label label-success" style="font-size: 14px;"></span></th>
                                                        <?php if($lineitem_image_2 == '1') { ?>
                                                            <th></th>
                                                        <?php } ?>
                                                    </tr>
                        ...
                        <div class="col-md-12">
                            <div class="ad_lineitem_form">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="ad_lineitem_data[ad_amount]" class="form-control num_only ad_amount" id="ad_amount" readonly="" >
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-md-10">
                                    <label for="ad_charges_remark">Remark</label>
                                    <input type="text" name="ad_lineitem_data[ad_charges_remark]" id="ad_charges_remark" class="form-control" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-body edit-content">
                        <div class="col-md-12">
                            <div class="sell_item_charges_details_form">
                                ...
                                <div class="col-md-2">
                                    <label for="sell_item_charges_details_net_wt">Ntwt/Pcs</label>
                                    <input type="text" name="sell_item_charges_details_data[sell_item_charges_details_net_wt]" class="form-control num_only" id="sell_item_charges_details_net_wt" >
                                </div>
                                <div class="col-md-2">
                                    <label for="sell_item_charges_details_per_gram">Rate</label>
                                ...
                                <div class="clearfix"></div>
                                <div class="col-md-10">
                                    <label for="sell_item_charges_details_remark">Remark</label>
                                    <input type="text" name="sell_item_charges_details_data[sell_item_charges_details_remark]" id="sell_item_charges_details_remark" class="form-control" value="">
                                </div>
                                <div class="col-md-2">
                                ...
                                <table style="" class="table custom-table item-table">
                                    <thead>
                                        <tr>
                                            <th width="80px">Action</th>
                                            <th>Ad</th>
                                            <th class="text-right">Ntwt/Pcs</th>
...
//                console.log(value);
        ...
        $(document).on('click', '#sell_item_charges_details', function () {
            ...
            var spi_pcs = $('#spi_pcs').val() || 0;
            spi_pcs = Math.abs(spi_pcs);
            if(net_wt != 0){
                $('#sell_item_charges_details_net_wt').val(net_wt);
            } else {
                $('#sell_item_charges_details_net_wt').val(spi_pcs);
            }
        ...
        $(document).on('click', '#sell_lineitem_charges_details', function () {
            ...
            net_wt = Math.abs(net_wt);
            var spi_pcs = $(this).attr('data-spi_pcs') || 0;
            spi_pcs = Math.abs(spi_pcs);
            if(net_wt != 0){
                $('#sell_item_charges_details_net_wt').val(net_wt);
            } else {
        ...
        $('#sell_item_charges_details_model').on('hidden.bs.modal', function () {
            ...
            if(sell_lineitem_charges_details == 1){
                ...
                var net_wt = lineitem_objectdata[sell_lineitem_charges_details_for_index].net_wt || 0;
                var spi_pcs = lineitem_objectdata[sell_lineitem_charges_details_for_index].spi_pcs || 0;
                var spi_rate = lineitem_objectdata[sell_lineitem_charges_details_for_index].spi_rate || 0;
                var spi_amount = 0;
                if(net_wt != 0){
                    spi_amount = parseFloat(net_wt) * parseFloat(spi_rate) / 10;
                } else {
                    spi_amount = parseFloat(spi_pcs) * parseFloat(spi_rate);
                }
                spi_amount = parseFloat(spi_amount) + parseFloat(total_sell_item_charges_details_amount);
                lineitem_objectdata[sell_lineitem_charges_details_for_index].amount = spi_amount;
...
//                var charges_amt_per = parseFloat(total_sell_item_charges_details_amount) / parseFloat(lineitem_objectdata[sell_lineitem_charges_details_for_index].gross_amount) * 100;
            ...
            $('#sell_item_charges_details_remark').val('');
        });
        $(document).on('keyup change', '#sell_item_charges_details_net_wt, #sell_item_charges_details_per_gram', function () {
...
//            console.log(pts_grwt + ' ' + pe_stock_grwt);
        ...
        $(document).bind('keyup change', '#net_wt, .touch_id, #wstg', function () {
            ...
            net_wt = round(net_wt, 2).toFixed(3);
            var wstg = 0; //parseFloat($('#wstg').val()) || 0;
            var sell_type_id = $('#sell_type_id').val();
        ...
        $(document).bind('keyup change', '#spi_pcs, #spi_rate, #charges_amt', function () {
            var net_wt = parseFloat($('#net_wt').val()) || 0;
            var spi_pcs = parseFloat($('#spi_pcs').val()) || 0;
            ...
            spi_amount = parseFloat(spi_amount) + parseFloat(charges_amt);
            spi_amount = round(spi_amount, 2).toFixed(2);
            $('#spi_amount').val(spi_amount);
        });
...
//                return false;
            ...
            lineitem['amount'] = parseFloat($('#spi_amount').val()) || 0;
...
//            });
        ...
        if(account_id != '' && account_id != null){
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#account_address').html('<strong>Account Address :</strong> ' + json.account_address);
                    $('#account_mobile').html('<strong>Mobile No. :</strong> ' + json.account_mobile);
    ...
    function get_bill_total_amount(){
        ...
        bill_amount = parseFloat(li_total_amount) + parseFloat(payment_receipt_amount) + parseFloat(gold_amount_count) + parseFloat(silver_amount_count) + parseFloat(transfer_amount_total) + parseFloat(ad_amount_total);
    ...
    function get_new_net_amount(){
        ...
        app_net_amt = parseFloat(app_gold_fine) + parseFloat(app_silver_fine) + (parseFloat(new_net_amount) || 0);
        $('#app_gold_fine').html(parseFloat(app_gold_fine).toFixed(0));
        $('#app_silver_fine').html(parseFloat(app_silver_fine).toFixed(0));
        $('#app_amount').html(parseFloat(new_net_amount).toFixed(0));
...
//        console.log(lineitem_objectdata);
        ...
        $.each(lineitem_objectdata, function (index, value) {
            ...
            <?php } ?>
            row_html += '<td class="text-right">' + parseFloat(spi_pcs).toFixed(2) + '</td>';
            row_html += '<td class="text-right">' + parseFloat(spi_rate).toFixed(2) + '</td>';
            row_html += '<td class="text-right"><a href="javascript:void(0)" id="sell_lineitem_charges_details" data-index="' + index + '" data-net_wt="' + parseFloat(net_wt).toFixed(3) + '" data-spi_pcs="' + parseFloat(spi_pcs).toFixed(3) + '" class="module_save_btn sell_lineitem_charges_details_' + index + '" style="margin: 0;">' + parseFloat(charges_amt).toFixed(2) + '</a></td>';
...
//        console.log(pay_rec_objectdata);
        ...
        $.each(pay_rec_objectdata, function (index, value) {
            ...
            var row_html = '<tr class="pay_rec_index_' + index + '"><td class=""  width="5%">' +
                    ...
                    if(value.narration != ''){
                        row_html += '<td width="8%">' + payment_receipt + ' @ '+ cash_cheque +'<br/>('+value.narration+')</td>';
                    } else {
                        row_html += '<td width="8%">' + payment_receipt + ' @ '+ cash_cheque +'</td>';
                    }
                    row_html += '<td width="5%">' + value.bank_name + '</td>' +
                    '<td width="5%"></td>' +
                    '<td width="5%"></td>' +
                    '<td width="5%"></td>' +
                    '<td width="4%"></td>' +
...
//            var metal_grwt = parseFloat(value.metal_grwt);
            ...
            var metal_html = '<tr class="metal_index_' + index + '"><td class=""  width="5%">' +
                    ...
                    if(value.metal_narration != ''){
                        metal_html += '<td width="8%">' + metal_pay_type + ' @ ' + value.metal_item_name + '<br/>('+value.metal_narration+')</td>';
                    } else {
                        metal_html += '<td width="8%">' + metal_pay_type + ' @ ' + value.metal_item_name + '</td>';
                    }
                    metal_html += '<td width="5%" class="text-right">' + parseFloat(metal_grwt).toFixed(3) + '</td>' +
                    '<td width="5%"></td>' +
                    '<td width="5%"></td>' +
    ...
    function display_ad_charges_html(ad_charges_objectdata) {
        ...
        $.each(ad_charges_objectdata, function (index, value) {
            ...
            var row_html = '<tr class="ad_charges_index_' + index + '"><td class="" width="5%">' +
                    ...
                    '</td>' +
                    '<td width="4%"></td>' +
                    '<td width="10%"> Charges : ' + value.ad_name + '<br><small>' + value.ad_charges_remark + '</small></td>' +
...
//        console.log(value.ad_charges_id);
        ...
        $("#ad_charges_remark").val(value.ad_charges_remark);
        $('#ajax-loader').hide();
    }
    ...
    function display_sell_item_charges_details_html(sell_item_charges_details_objectdata) {
        ...
        $.each(sell_item_charges_details_objectdata, function (index, value) {
            ...
            var row_html = '<tr class="lineitem_index_' + index + '"><td class="">' +
                    ...
                    '<td>' + value.sell_item_charges_details_remark + '</td>';
    ...
    function edit_sell_item_charges_details(index) {
        ...
        $("#sell_item_charges_details_remark").val(value.sell_item_charges_details_remark);
        $('#ajax-loader').hide();
    }
...
//            console.log(input.files);
    ...
    function save_form(postData, href_url){
        ...
        postData.append('bill_cr_c_amount', 0);
        postData.append('bill_cr_r_amount', 0);
