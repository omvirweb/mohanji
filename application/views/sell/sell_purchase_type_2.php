                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <?php } ?>
                                    <div class="clearfix"></div>
                                    <div class="line_item_form item_fields_div" style="height: 200px;">
                                        ...
                                        <div class="col-md-1 pr0">
                                            <label for="grwt">Gross<span class="required-sign">&nbsp;*</span></label>
                                        ...
                                        <div class="col-md-1 pr0">
                                            ...
                                            <input type="text" name="line_items_data[stone_wt]" class="form-control stone_wt num_only" id="stone_wt" placeholder="" value="">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="sijat">Sijat</label>
                                            <input type="text" name="line_items_data[sijat]" class="form-control sijat num_only" id="sijat" placeholder="" value="">
                                        </div>
                                        <div class="col-md-1 pr0">
                                        ...
                                        <div class="col-md-1 pr0">
                                            <label for="touch_id">Tunch</label>
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-1 pr0">
                                            <label for="wastage_labour">Wastage / Labour</label>
                                            <select name="line_items_data[wastage_labour]" id="wastage_labour" class="form-control select2">
                                                <option value=""> - Select - </option>
                                        ...
                                        <div class="col-md-1 pr0">
                                            <label for="wastage_labour_value">Wastage / Labour Value</label>
                                            <input type="text" name="line_items_data[wastage_labour_value]" class="form-control num_only" id="wastage_labour_value" placeholder="" value="">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="labour_amount">Labour Amount</label>
                                            <input type="text" name="line_items_data[labour_amount]" class="form-control num_only" id="labour_amount" placeholder="" value="">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="fine_gold_silver">Fine Gold/Silver</label>
                                            <input type="text" name="line_items_data[fine_gold_silver]" class="form-control num_only" id="fine_gold_silver" placeholder="" value="" readonly="">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="gold_silver_rate">Gold/Silver Rate</label>
                                            <input type="text" name="line_items_data[gold_silver_rate]" class="form-control num_only" id="gold_silver_rate" placeholder="" value="" >
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="gold_silver_amount">Gold/Silver Amount</label>
                                            <input type="text" name="line_items_data[gold_silver_amount]" class="form-control num_only" id="gold_silver_amount" placeholder="" value="" >
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="stone_qty">Stone<br> Qty</label>
                                            <input type="text" name="line_items_data[stone_qty]" class="form-control num_only" id="stone_qty" placeholder="" value="" >
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="stone_rs">Stone<br> Rs.</label>
                                            <input type="text" name="line_items_data[stone_rs]" class="form-control num_only" id="stone_rs" placeholder="" value="">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="charges_amt"><br>Charge <a href="javascript:void(0)" id="sell_item_charges_details" class="module_save_btn" style="margin: 0; font-size: 9px;">Details[F9]</a></label>
                                            <input type="text" name="line_items_data[charges_amt]" class="form-control num_only" id="charges_amt" placeholder="" value="">
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="total_amount">Total<br> Amount</label>
                                            <input type="text" name="line_items_data[total_amount]" class="form-control" id="total_amount" placeholder="" value="" readonly>
                                        </div>
                                        <div class="col-md-1 pr0">
                                            <label for="li_narration"><br>Narration</label>
                                        ...
                                        <?php if($lineitem_image_2 == '1') { ?>
                                            <div class="col-md-1 pr0">
                                                <label for="file_upload"><br>Image</label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            <table class="table table-bordered display border">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="5%" class="text-right">Stone Wt.</th>
                                                        <th width="5%" class="text-right">Sijat</th>
                                                        <th width="5%" class="text-right">Less</th>
                                                        <th width="5%" class="text-right">Net.Wt</th>
                                                        <th width="5%" class="text-right">Tunch</th>
                                                        <th width="4%" class="text-right">Wastage / Labour</th>
                                                        <th width="4%" class="text-right">Wastage / Labour Value</th>
                                                        <th width="7%" class="text-right">Labour Amount</th>
                                                        <th width="7%" class="text-right">Fine Gold/Silver</th>
                                                        <th width="7%" class="text-right">Gold/Silver Rate</th>
                                                        <th width="6%" class="text-right">Gold/Silver Amount</th>
                                                        <th width="6%" class="text-right">Stone Qty</th>
                                                        <th width="6%" class="text-right">Stone Rs.</th>
                                                        <th width="6%" class="text-right">Charge</th>
                                                        <th width="6%" class="text-right">Total Amount</th>
                                                        <?php if($lineitem_image_2 == '1') { ?>
                                                            <th width="5%">Image</th>
                                                        <?php } ?>
                                                    </tr>
                                                ...
                                                <tfoot id="lineitem_foot_list">
                                                    <tr>
                                                        ...
                                                        <th class="text-right"><span id="">0.000</span></th>
                                                        <th class="text-right"><span id="">0.000</span></th>
                                                        <th class="text-right"><span id="total_ntwt"></span></th>
                                                        <th></th>
                                                        <th class="text-right"><span id=""></span></th>
                                                        <th class="text-right"><span id=""></span></th>
                                                        <th class="text-right"><span id=""></span></th>
                                                        <th class="text-right"><span id="fine_gold_silver_total"></span></th>
                                                        <th class="text-right"><span id=""></span></th>
                                                        <th class="text-right"><span id="gold_silver_amount_total"></span></th>
                                                        <th class="text-right"><span id=""></span></th>
                                                        <th class="text-right"><span id="stone_rs_amount_total"></span></th>
                                                        <th class="text-right"><span id="charge_amount_total"></span></th>
                                                ...
                                                <tbody id="pop_up_total_list">
                                                    <?php if($ask_discount_in_sell_purchase == '1') { ?>
                                                        <tr>
                                                            ...
                                                            <th width="5%" class="text-right"></th>
                                                            <th width="5%" class="text-right"></th>
                                                            <th width="12%" colspan="2" class="text-right">Discount Amount : </th>
                                                            ...
                                                            <th width="6%" class="text-right"></th>
                                                            <th width="6%" class="text-right"></th>
                                                            <th width="6%" class="text-right"><input type="text" name="discount_amount" id="discount_amount" class="form-control input-sm" value="<?php if (isset($sell_data->discount_amount) && !empty($sell_data->discount_amount)) { echo $sell_data->discount_amount; } else { echo '0';} ?>" style="width:60px;"></th>
                                                            <?php if($lineitem_image_2 == '1') { ?>
                                                                <th width="5%"></th>
                                                            <?php } ?>
                                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th width="5%" class="text-right"></th>
                                                        <th width="5%" class="text-right"></th>
                                                        <th width="12%" colspan="2" class="text-right">Bill Balance : </th>
...
<script type="text/javascript">
    ...
    var gold_silver_amount_total = 0;
    var stone_rs_amount_total = 0;
...
if (isset($transfer_data)) { ?>
    transfer_objectdata = <?php echo $transfer_data; ?>;
    $('.transfer_table').show();
<?php } 
...
//                var charges_amt_per = parseFloat(total_sell_item_charges_details_amount) / parseFloat(lineitem_objectdata[sell_lineitem_charges_details_for_index].gross_amount) * 100;
        ...
        $(document).on('change', '#sell_type_id', function () {
            ...
            $("#touch_id").val(null).trigger("change");
            $("#touch_data_id").val('');
            $("#wastage_labour").val(null).trigger("change");
            $("#wastage_labour_value").val('');
            $("#labour_amount").val('');
            $("#fine_gold_silver").val('');
            $("#gold_silver_rate").val('');
            $("#gold_silver_amount").val('');
            $("#stone_qty").val('');
            $("#stone_rs").val('');
            $("#charges_amt").val('');
            $("#total_amount").val('');
...
//            console.log(pts_grwt + ' ' + pe_stock_grwt);
        ...
        $(document).on('keyup change', '#grwt, #stone_wt, #sijat, #less', function () {
            var grwt = parseFloat($('#grwt').val()) || 0;
            grwt = round(grwt, 2).toFixed(3);
            var stone_wt = parseFloat($('#stone_wt').val()) || 0;
            stone_wt = round(stone_wt, 2).toFixed(3);
            var sijat = parseFloat($('#sijat').val()) || 0;
            sijat = round(sijat, 2).toFixed(3);
            var less = parseFloat($('#less').val()) || 0;
            less = round(less, 2).toFixed(3);
            if(parseFloat(stone_wt) > parseFloat(grwt)){
                show_notify('Stone Wt Can not be > grwt.', false);
                $("#stone_wt").val('');
                $("#stone_wt").focus();
                return false;
            }
            ...
            var net_wt = 0;
            net_wt = parseFloat(grwt) - parseFloat(stone_wt) + parseFloat(sijat) - parseFloat(less);
            net_wt = round(net_wt, 2).toFixed(3);
            $('#net_wt').val(net_wt).change();
        });

        $(document).on('keyup change', '#net_wt, .touch_id, #wastage_labour, #wastage_labour_value', function () {
            var grwt = parseFloat($('#grwt').val()) || 0;
            var net_wt = parseFloat($('#net_wt').val()) || 0;
            net_wt = round(net_wt, 2).toFixed(3);
            var wastage_labour = parseFloat($('#wastage_labour').val());
            var labour_value = 0;
            var wastage_value = 0;
            if(wastage_labour == '1'){
                var wastage_value = parseFloat($('#wastage_labour_value').val()) || 0;
                $('#labour_amount').val('0.00');
                $('#labour_amount').attr('readonly', 'readonly');
            } else if(wastage_labour == '2'){
                var labour_value = parseFloat($('#wastage_labour_value').val()) || 0;
                $('#labour_amount').removeAttr('readonly', 'readonly');
            }
            var sell_type_id = $('#sell_type_id').val();
            if (sell_type_id == '<?php echo SELL_TYPE_EXCHANGE_ID; ?>') {
            ...
            var labour_amount = 0;
            labour_amount = parseFloat(grwt) * parseFloat(labour_value);
            labour_amount = labour_amount.toFixed(2);
            $('#labour_amount').val(labour_amount);
            var fine_gold_silver = 0;
            fine_gold_silver = parseFloat(net_wt) * (parseFloat(touch) + parseFloat(wastage_value)) / 100;
            fine_gold_silver = round(fine_gold_silver, 2).toFixed(3);
            $('#fine_gold_silver').val(fine_gold_silver);
        });

        $(document).bind('keyup change', '#fine_gold_silver, #gold_silver_rate', function () {
            var fine_gold_silver = parseFloat($('#fine_gold_silver').val()) || 0;
            var gold_silver_rate = parseFloat($('#gold_silver_rate').val()) || 0;
            var gold_silver_amount = 0;
            gold_silver_amount = parseFloat(fine_gold_silver) * (parseFloat(gold_silver_rate)) / 10;
            gold_silver_amount = gold_silver_amount.toFixed(2);
            $('#gold_silver_amount').val(gold_silver_amount);
        });

        $(document).bind('keyup change', '#labour_amount, #gold_silver_amount, #stone_rs, #charges_amt', function () {
            var labour_amount = parseFloat($('#labour_amount').val()) || 0;
            var gold_silver_amount = parseFloat($('#gold_silver_amount').val()) || 0;
            var stone_rs = parseFloat($('#stone_rs').val()) || 0;
            var charges_amt = parseFloat($('#charges_amt').val()) || 0;
            var total_amount = 0;
            total_amount = parseFloat(labour_amount) + parseFloat(gold_silver_amount) + parseFloat(stone_rs) + parseFloat(charges_amt);
...
//            console.log(clickbtn['selector']); return false;
            ...
            var href_url = '<?= base_url('sell_purchase_type_2/save_sell') ?>';
            if(is_grater == 1){
        ...
        $('#add_lineitem').on('click', function () {
            ...
            <?php /* if (sell_type_id == '<?php SELL_TYPE_EXCHANGE_ID ?>') {
            ...
            lineitem['amount'] = parseFloat($('#total_amount').val()) || 0;
...
//            });
    ...
    function display_lineitem_html(lineitem_objectdata) {
        ...
        gold_silver_amount_total = 0;
        stone_rs_amount_total = 0;
        ...
        $.each(lineitem_objectdata, function (index, value) {
            ...
            var stone_wt = value.stone_wt || 0;
            var sijat = value.sijat || 0;
            var less = value.less || 0;
            var net_wt = value.net_wt || 0;
            var touch_id = value.touch_id;
            var wastage_labour = '';
            if(value.wastage_labour == '1'){
                wastage_labour = 'Wastage';
            } else if(value.wastage_labour == '2'){
                wastage_labour = 'Labour';
            }
            var wastage_labour_value = value.wastage_labour_value || 0;
            var labour_amount = value.labour_amount || 0;
            var fine_gold_silver = value.fine_gold_silver || 0;
            var gold_silver_rate = value.gold_silver_rate || 0;
            var gold_silver_amount = value.gold_silver_amount || 0;
            var stone_qty = value.stone_qty || 0;
            var stone_rs = value.stone_rs || 0;
            var charges_amt = value.charges_amt || 0;
            var total_amount = value.total_amount || 0;

            if(value.type_name == 'S'){
                fine_gold_silver = zero_value - parseFloat(fine_gold_silver); // Sell to Gold/Silver fine Decrease
                gold_silver_amount = parseFloat(gold_silver_amount); // Sell to Gold/Silver Amount Increase
            } else {
                grwt = zero_value - parseFloat(grwt);
                stone_wt = zero_value - parseFloat(stone_wt);
                sijat = zero_value - parseFloat(sijat);
                less = (less != '') ? 0 - parseFloat(less) : less;
                net_wt = zero_value - parseFloat(net_wt);
                touch_id = zero_value - parseFloat(touch_id);
                wastage_labour_value = zero_value - parseFloat(wastage_labour_value);
                labour_amount = zero_value - parseFloat(labour_amount);
                fine_gold_silver = parseFloat(fine_gold_silver); // Purchase to Gold/Silver fine Increase
                gold_silver_amount = zero_value - parseFloat(gold_silver_amount); // Purchase to Gold/Silver Amount Decrease
                stone_qty = zero_value - parseFloat(stone_qty);
                stone_rs = zero_value - parseFloat(stone_rs);
                charges_amt = zero_value - parseFloat(charges_amt);
                total_amount = zero_value - parseFloat(total_amount);
            }
            ...
            if(value.group_name == '<?php echo CATEGORY_GROUP_GOLD_ID; ?>'){
                li_total_gold_fine = li_total_gold_fine + parseFloat(fine_gold_silver);
                var gold_value = parseFloat(fine_gold_silver);
                var silver_value = '';
            } else {
                li_total_silver_fine = li_total_silver_fine + parseFloat(fine_gold_silver);
                var gold_value = '';
                var silver_value = parseFloat(fine_gold_silver);
            }
            gold_silver_amount_total = gold_silver_amount_total + parseFloat(gold_silver_amount);
            stone_rs_amount_total = stone_rs_amount_total + parseFloat(stone_rs);
            charge_amount_total = charge_amount_total + parseFloat(charges_amt);
            li_total_amount = li_total_amount + parseFloat(total_amount);
            ...
            row_html += '<td>' + value.item_name + '<br><small>' + value_li_narration + '</small></td>' +
                    ...
                    '<td class="text-right">' + parseFloat(stone_wt).toFixed(3) + '</td>' +
                    '<td class="text-right">' + parseFloat(sijat).toFixed(3) + '</td>';
            ...
            row_html += '<td class="text-right">' + wastage_labour + '</td>';
            row_html += '<td class="text-right">' + wastage_labour_value + '</td>';
            row_html += '<td class="text-right">' + labour_amount + '</td>';
            row_html += '<td class="text-right">' + fine_gold_silver + '</td>';
            row_html += '<td class="text-right">' + gold_silver_rate + '</td>';
            row_html += '<td class="text-right">' + gold_silver_amount + '</td>';
            row_html += '<td class="text-right">' + stone_qty + '</td>';
            row_html += '<td class="text-right">' + stone_rs + '</td>';
//            row_html += '<td class="text-right"><a href="javascript:void(0)" id="sell_lineitem_charges_details" data-index="' + index + '" data-net_wt="' + parseFloat(net_wt).toFixed(3) + '" class="module_save_btn sell_lineitem_charges_details_' + index + '" style="margin: 0;">' + parseFloat(charges_amt).toFixed(2) + '</a></td>';
            row_html += '<td class="text-right">' + parseFloat(charges_amt).toFixed(2) + '</td>';
            row_html += '<td class="text-right">' + total_amount + '</td>';
            <?php if($lineitem_image_2 == '1') { ?>
                row_html += '<td>';
                if (value.image !== null && value.image !== '') {
                    ...
                    row_html += '<a href="javascript:void(0)" class="btn btn-xs btn-primary image_model" data-img_src="' + img_url + '" ><i class="fa fa-image"></i></a>';
                }
                row_html += '</td>';
            <?php } ?>
        ...
        var fine_gold_silver_total = parseFloat(li_total_gold_fine) + parseFloat(li_total_silver_fine);
        var fine_gold_silver_total = parseFloat(fine_gold_silver_total).toFixed(3);
        $('#fine_gold_silver_total').html(fine_gold_silver_total);
        $('#gold_silver_amount_total').html(parseFloat(gold_silver_amount_total).toFixed(2));
        $('#stone_rs_amount_total').html(parseFloat(stone_rs_amount_total).toFixed(2));
        $('#charge_amount_total').html(parseFloat(charge_amount_total).toFixed(2));
...
//        console.log(value);
        ...
        if(value.purchase_sell_item_id == '' || value.purchase_sell_item_id == null){
            ...
            $("#grwt").val(value.grwt);
            $("#stone_wt").val(value.stone_wt);
            $("#sijat").val(value.sijat);
            $("#less").val(value.less);
            $("#net_wt").val(value.net_wt);
            $(".touch_id").val(value.touch_id).trigger("change");
            $("#wastage_labour").val(value.wastage_labour).trigger("change");
            $("#wastage_labour_value").val(value.wastage_labour_value);
            $("#labour_amount").val(value.labour_amount);
            $("#fine_gold_silver").val(value.fine_gold_silver);
            $("#gold_silver_rate").val(value.gold_silver_rate);
            $("#gold_silver_amount").val(value.gold_silver_amount);
            $("#stone_qty").val(value.stone_qty);
            $("#stone_rs").val(value.stone_rs);
...
//        $(".metal_payment_receipt").val(value.metal_payment_receipt).attr('checked', 'checked');
    ...
    function display_gold_html(gold_objectdata) {
        ...
        $.each(gold_objectdata, function (index, value) {
            if(value.through_lineitem){ return; }
