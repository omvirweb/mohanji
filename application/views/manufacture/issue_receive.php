...
<div class="content-wrapper" id="body-content">
    <form class="form-horizontal" action="<?= base_url('manufacture/save_issue_receive') ?>" method="post" id="save_issue_receive" novalidate enctype="multipart/form-data">                                    
        ...
        <section class="content-header">
            <h1>
                ...
                <?php if($isView){ ?>
                    <a href="<?= base_url('manufacture/issue_receive_list') ?>" class="btn btn-primary btn-sm pull-right" style="margin: 5px;">Issue/Receive List</a>
                <?php } ?>
            </h1>
        </section>
        <div class="clearfix">
                            ...
                            <div class="box-body">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <?php if($this->applib->have_access_role(MANUFACTURE_MODULE_ID,"allow to lott complete")) { ?>
                                                    <label><input type="radio" name="lott_complete" class="iradio_minimal-blue" value="1" <?= (isset($ir_data->lott_complete)) && $ir_data->lott_complete == 1 ? 'checked' : ''; ?>> Yes</label> &nbsp;&nbsp;&nbsp;
                                                    <label><input type="radio" name="lott_complete" class="iradio_minimal-blue" value="0" <?= (isset($ir_data->lott_complete)) ? $ir_data->lott_complete == 0 ? 'checked' : '' : 'checked'; ?>> No</label>
                                                <?php } else { ?>
                                                    <?= (isset($ir_data->lott_complete)) && $ir_data->lott_complete == 1 ? 'Yes' : 'No'; ?>
                                                    <input type="hidden" name="lott_complete" value="<?= (isset($ir_data->lott_complete)) && $ir_data->lott_complete == 1 ? '1' : '0'; ?>">
                                                <?php } ?>
                                                <div class="col-md-8">
                                                    <div id="ir_diffrence_calculation"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <?php $lott_complete_hide =  (isset($ir_data->lott_complete)) ? $ir_data->lott_complete == 0 ? 'hide' : '' : 'hide'; ?>
                                        <div class="lott_complete_div <?php echo $lott_complete_hide; ?> ">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="ir_diffrence">Difference : </label><br />
                                                    <span id="ir_diffrence_value"><?= (isset($ir_data->ir_diffrence)) ? $ir_data->ir_diffrence  : ''; ?></span>
                                                    <?php if($manufacture_lott_complete_in == '1'){ ?>
                                                    <span id="ir_diffrence_in" class="text-bold">Gr.Wt.</span>
                                                    <?php } else { ?>
                                                        <span id="ir_diffrence_in" class="text-bold">Fine</span>
                                                    <?php } ?>
                                                    <input type="hidden" name="ir_diffrence" id="ir_diffrence" class="num_only form-control" value="<?= (isset($ir_data->ir_diffrence)) ? $ir_data->ir_diffrence  : ''; ?>">
                                                </div>
                                                <?php if($manufacture_lott_complete_in == '3'){ ?>
                                                    <div class="col-md-4">
                                                        <label for="worker_gold_rate">Worker Gold Rate</label>
                                                        <input type="text" name="worker_gold_rate" id="worker_gold_rate" class="num_only form-control" value="<?= (isset($ir_data->worker_gold_rate)) ? $ir_data->worker_gold_rate  : ''; ?>">
                                                    </div>
                                                    <div class="col-md-4"><br/>
                                                        Amount : <span id="ir_diffrence_amount"></span><br />
                                                        <?php /*<input type="checkbox" name="lott_complete_sms" id="lott_complete_sms">
                                    ...
                                    <div class="line_item_form item_fields_div">
                                        ...
                                        <input type="hidden" name="line_items_data[ir_item_delete]" id="ir_item_delete" value="allow" />
                                        <?php if(isset($issue_receive_detail) && !empty($issue_receive_detail)){ ?>
                                            <input type="hidden" name="line_items_data[ird_id]" id="ird_id" />
                                        ...
                                        <div class="col-md-1">
                                            <label for="wastage">Wastage<span class="required-sign">&nbsp;*</span></label>
                                            <input type="text" name="line_items_data[wastage]" class="form-control num_only" id="wastage"  placeholder="" value=""><br />
                                        </div>
                                        <div class="col-md-1">
                                        ...
                                        <div class="col-md-1">
                                            <label for="calculated_wastage">Cal.Wastage<span class="required-sign">&nbsp;*</span></label>
                                            <input type="text" name="line_items_data[calculated_wastage]" class="form-control num_only" id="calculated_wastage"  placeholder="" value="" readonly=""><br />
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="col-md-1">
                                            <label for="ird_date">Date<span class="required-sign">&nbsp;*</span></label>
                                            <input type="text" name="line_items_data[ird_date]" class="form-control datepicker" id="ird_date" placeholder="" ><br />
                                        </div>
                                        <div class="col-md-3">
                                            <label for="ird_remark">Remark</label>
                                            <textarea name="line_items_data[ird_remark]" class="form-control" id="ird_remark" placeholder=""></textarea><br />
                                        </div>
                                        ...
                                        <table style="" class="table custom-table item-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-right">Cal. Wastage</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="text-right" id="total_receive_wastage1"></th>
                                                    <th class="text-right" id="total_receive_fine"></th>
                                                    <th class="text-right" id="total_receive_calculated_wastage"></th>
                                                    <th></th>
                                                    <th></th>
                                                </tr>
                                            </tfoot>
                                        ...
                                        <table style="" class="table custom-table item-table">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="text-right" id="total_issue_wastage1"></th>
                                                    <th class="text-right" id="total_issue_fine"></th>
                                                    <th class="text-right" id="total_issue_calculated_wastage"></th>
                                                    <th></th>
                                                    <th></th>
                                                </tr>
                                            </tfoot>
                                    ...
                                    <div class="col-md-8">
                                        <table style="" class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-right bg-aqua">Tunch</th>
                                                    <th class="text-right bg-aqua">Balance Gross</th>
                                                    <th class="text-right bg-yellow">Karigar Rec. Wastage</th>
                                                    <th class="text-right bg-yellow">Karigar Issue Wastage</th>
                                                    <th class="text-right bg-yellow">Kariagar Balance Wastage</th>
                                                    <th class="text-right bg-aqua">Gross with Karigar</th>
                                                    <th class="text-right bg-aqua">Karigar Fine</th>
                                                    <th class="text-right bg-yellow">Balance Net.Wt</th>
                                                    <th class="text-right bg-yellow">Balance Fine</th>
                                                </tr>
                                            </thead>
                                            <tbody id="balance_calculation_list" style="background-color: #FFE495;"></tbody>
                                            <tfoot>
                                                <tr>
                                                    <th class="text-right bg-aqua">Total</th>
                                                    <th class="text-right bg-aqua"><span id="total_weight"></span></th>
                                                    <th class="text-right bg-yellow"><span id="karigar_receive_wastage"></span></th>
                                                    <th class="text-right bg-yellow"><span id="karigar_issue_wastage"></span></th>
                                                    <th class="text-right bg-yellow"><span id="karigar_balance_wastage"></span></th>
                                                    <th class="text-right bg-aqua"><span id="gross_with_karigar"></span></th>
                                                    <th class="text-right bg-aqua"><span id="karigar_fine"></span></th>
                                                    <th class="text-right bg-yellow"><span id="total_net_wt"></span></th>
                                                    <th class="text-right bg-yellow"><span id="total_fine"></span></th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
        ...
        $(document).bind("keydown", function(e){
            if(e.ctrlKey && e.which == 83){
                ...
                if(module_submit_flag == 0 ){
                    $("#save_issue_receive").submit();
                    return false;
                }
            }
        });

        $(document).on('submit', '#save_issue_receive', function () {
            ...
            $.ajax({
                url: "<?= base_url('manufacture/save_issue_receive') ?>",
                type: "POST",
                processData: false,
                contentType: false,
                cache: false,
                ...
                success: function (response) {
                    ...
                    if (json['error'] == 'Something went Wrong') {
                        ...
                        <?php //if($manufacture_lott_complete_in == '3'){ ?>
                            window.location.href = "<?php echo base_url('manufacture/issue_receive_list') ?>";
                        <?php /* } else { ?>
                            var checked_items = new Array();
                            checked_items.push(json['ir_id']);
                            var worker_id = $('#worker_id').val();
                            var department_id = $('#department_id').val();
                            var hisab_date = $("#datepicker2").val();
                            var fine = $("#ir_diffrence").val();
                            var is_module = '<?php echo HISAB_DONE_IS_MODULE_MIR; ?>';
                            $.ajax({
...
//                    '<td class="text-right"><input type="text" name="pts_wstg[]" id="pts_wstg_' + index + '" data-pts_selected_index="' + index + '" class="pts_wstg num_only" value="'+ value.wstg + '" style="width:100px;"></td>' +
    ...
    function display_lineitem_html(lineitem_objectdata) {
        ...
        $('#save_issue_receive').append('<input type="hidden" name="total_issue_net_wt" id="total_issue_net_wt" value="' + total_issue_net_wt + '" />');
        $('#save_issue_receive').append('<input type="hidden" name="total_receive_net_wt" id="total_receive_net_wt" value="' + total_receive_net_wt + '" />');
        $('#save_issue_receive').append('<input type="hidden" name="total_issue_fine" id="total_issue_fine" value="' + total_issue_fine + '" />');
        $('#save_issue_receive').append('<input type="hidden" name="total_receive_fine" id="total_receive_fine" value="' + total_receive_fine + '" />');
        $('#ajax-loader').hide();
        set_total_weight();
        set_total_net_wt();
        set_total_fine();
